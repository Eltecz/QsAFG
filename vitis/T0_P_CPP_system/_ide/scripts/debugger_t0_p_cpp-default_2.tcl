...
# Path of this script: /mnt/hgfs/DBS/a7_awg_p1/vitis/T0_P_CPP_system/_ide/scripts/debugger_t0_p_cpp-default_2.tcl
# 
# 
# Usage with xsct:
# To debug using xsct, launch xsct and run below command
# source /mnt/hgfs/DBS/a7_awg_p1/vitis/T0_P_CPP_system/_ide/scripts/debugger_t0_p_cpp-default_2.tcl
# 
...
after 3000
targets -set -nocase -filter {name =~ "*microblaze*#0" && bscan=="USER2" }
dow /mnt/hgfs/DBS/a7_awg_p1/vitis/T0_P_CPP/Debug/T0_P_CPP.elf
bpadd -addr &main
